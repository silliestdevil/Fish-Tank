...
class Target {
  constructor(initialPosition, game) {
    ...
    setInterval(() => this.updatePosition(), 1000 / 60); // Update every frame (60 FPS)
    setInterval(() => this.startFetchingVol(), 5000); // Fetch volume every 5 seconds
  }
